    ...
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isWithinRange ? Colors.black87 : AppConstants.errorColor,
              ),
            ),
          ],
        ),
        ...
        if (showDetails) ...[
          ...
          Text(
            'Required: ${TemperatureUtils.formatTemperature(effectiveMinTemperature)} to ${TemperatureUtils.formatTemperature(effectiveMaxTemperature)}',
          ...
          Row(
            children: [
              ...
              Text(
                '${effectiveZone.toString().split('.').last} zone',
                style: const TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.w500,
                  color: Colors.black54,
