...
class OrderService {
  ...
  final List<Order> _demoOrders = [
    Order(
      ...
      deliveryAddress: DeliveryAddress.fromString('123 Main St, Anytown, USA'),
    ...
    Order(
      ...
      deliveryAddress: DeliveryAddress.fromString('456 Elm St, Anytown, CA 12345'),
    ...
    Order(
      ...
      deliveryAddress: DeliveryAddress.fromString('789 Oak St, Anytown, CA 12345'),
    ...
    Order(
      ...
      deliveryAddress: DeliveryAddress.fromString('123 Main St, Anytown, CA 12345'),
